(function(g, v) {
    ...
    function wa(a) {
        ...
        switch (f.getUint8(0)) {
            ...
            case 32:
                ...
                break;
            case 48:
                for (z = []; c < f.byteLength;) z.push(b());
                za();
                break;
            case 64:
                X = f.getFloat64(1, !0), Y = f.getFloat64(9, !0), Z = f.getFloat64(17, !0), $ = f.getFloat64(25, !0), 0 == m.length && (w = (Z + X) / 2, x = ($ + Y) / 2)
        }
    }
    ...
    function ya(a) {
        ...
        for (var f = a.getUint16(c, !0), c = c + 2, d = 0; d < f; ++d) {
            var e = y[a.getUint32(c, !0)],
                t = y[a.getUint32(c + 4, !0)],
                c = c + 8;
        ...
        for (;;) {
            ...
            k = null;
            y.hasOwnProperty(f) ? (k = y[f], k.updatePos(), k.ox = k.x, k.oy = k.y, k.oSize = k.size, k.color = l) : (k = new oa(f, d, e, t, l, h, g), k.pX = d, k.pY = e);
            k.nx = d;
            k.ny = e;
            k.nSize = t;
            k.updateCode = b;
            k.updateTime = F; - 1 != D.indexOf(f) && -1 == m.indexOf(k) && (document.getElementById("overlays").style.display = "none", m.push(k), 1 == m.length && (w = k.x, x = k.y))
        }
        a.getUint16(c, !0);
        c += 2;
        e = a.getUint32(c, !0);
        c += 4;
        for (d = 0; d < e; d++) f = a.getUint32(c, !0), c += 4, y[f] && (y[f].updateCode = b);
        for (d = 0; d < r.length; d++) r[d].updateCode != b && r[d--].destroy();
        aa && 0 == m.length && v("#overlays").fadeIn(3E3)
    }
...
/* **************************************************************** */
    ...
    function Ca() {
        for (var a = 0, b = 0; b < m.length; b++) a += m[b].nSize * m[b].nSize * 200;
        return a
    }
        ...
        oa.prototype = {
            ...
            draw: function() {
                if (this.shouldRender()) {
                    ...
                    ra ? -1 != Ea.indexOf(a) ? (R.hasOwnProperty(a) || (R[a] = new Image, R[a].src = "skins/" + a + ".png"), b = R[a]) : b = null : b = null;
                    ...
                    sa && a && (null == this.sizeCache && (this.sizeCache = new P(this.getNameSize() / 2, "#FFFFFF", !0, "#000000")), this.sizeCache.setSize(this.getNameSize() / 2), this.sizeCache.setValue(~~(this.size * this.size / 100)), c = this.sizeCache.render(), d.drawImage(c, ~~this.x - ~~(c.width / 2), b - ~~(c.height / 2)));
                    d.restore()
                }
            }
        };
